				...
				>
					...
					<div class="space-y-4 flex-1">
						<div class="flex flex-col h-full">
							...
							<p class="mb-3">
								1st floor, aziz super market, Lalon shah road, fultola, sewria,
								Kushtia, Bangladesh
							</p>
					...
					<div class="space-y-4 flex-1">
						<div class="flex flex-col h-full">
							...
							<p class="mb-3">contact@lyriczsoftwares.com</p>
					...
					<div class="space-y-4 flex-1">
						<div class="flex flex-col h-full">
							...
							<NuxtLink
								to="https://www.facebook.com/profile.php?id=61562053261054"
								target="_blank"
							>
								facebook
								<UIcon name="fa6-brands-facebook" dynamic />
							</NuxtLink>
							<hr />
						</div>
					</div>
